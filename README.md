...
| **Monorepo Architecture** | VGV layered monorepo architecture — four-layer package structure (Data, Repository, Business Logic, Presentation), dependency rules, data flow, and bootstrap wiring |
