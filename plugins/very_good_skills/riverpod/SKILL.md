---
name: riverpod
description: Best practices when using Riverpod for state management and dependency injection in Flutter/Dart applications, including testing with ProviderContainer and mocktail.
---
